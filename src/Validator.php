...
class Validator implements ValidatorInterface
{
     ...
     *
     * @return string Message template string
     *
     * @throws RuntimeException When no template file found for locale
     */
    protected function getTemplate(string $message): string
    {
        ...
        $template = $templates[$message] ?? $templates['default'];

        return is_string($template) ? $template : $templates['default'];
    }
     ...
     * @param string|null $sourceClass Current source class
     */
     ...
     * @param list<ConstraintInterface> $constraints Constraint instances to apply
     *
