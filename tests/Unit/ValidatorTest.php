...
class ValidatorTest extends TestCase
{
    ...
    public function testValidateValueWithoutConstraintsReturnsOriginalValue(): void
    {
        $result = $this->validator->validateValue('plainField', 'raw-value', []);
    ...
    public function testFormatMessageFallsBackToStandardI18nFieldLabelWithShortSourceClassKey(): void
    {
        $validator = $this->makeValidatorWithResources(
            ...
            translations: [
                'validation.labels.ValidatorTest::email' => '邮箱',
            ],
        );
    ...
    public function testValidateFailedExceptionLocalizesApiErrorsAcrossLocales(): void
    {
        ...
        $validator = $this->makeValidatorWithLocaleResources(
            ...
            translationsByLocale: [
                'en' => [
                    'validation.labels.ValidatorTest::email' => 'Email address',
                ],
                'zh-cn' => [
                    'validation.labels.ValidatorTest::email' => '邮箱地址',
                ],
                'zh' => [
                    'validation.labels.ValidatorTest::email' => '電郵地址',
                ],
            ],
        );
    ...
    protected function makeValidatorWithLocaleResources(
        ...
        $baseDir = sys_get_temp_dir() . '/switon-validation-' . uniqid('', true);
